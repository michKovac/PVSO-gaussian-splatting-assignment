...
Students will go through the full pipeline from photographs to an interactive 3D viewer,
...
% ── TASK 1 ───────────────────────────────────────────────────────────────────
\item \textbf{[5~pts.]} Running the pipeline on a reference dataset.\\
...
Run the full pipeline from scratch following the guide in \texttt{NAVOD.md}:
...
% ── TASK 2 ───────────────────────────────────────────────────────────────────
\item \textbf{[8~pts.]} Capturing your own scene with the Ximea camera.\\
...
Run the full pipeline in the same way as in Task~1.
Report the achieved PSNR and visually compare the result with the reference dataset.

% ── TASK 3 ───────────────────────────────────────────────────────────────────
\item \textbf{[4~pts.]} Evaluation of results.\\
...
% ── TASK 4 ───────────────────────────────────────────────────────────────────
\item \textbf{[4~pts.]} Theoretical explanation of the method.\\
Explain the following concepts in the documentation (in your own words, not copy-paste):
\begin{itemize}
    \item What are 3D Gaussians and what parameters do they have ($\mu, \Sigma, \alpha$, colour).
    \item What COLMAP (SfM) does and why it is necessary.
    \item How splatting works -- projection to 2D and alpha blending.
    \item What the loss function optimises during training.
\end{itemize}

% ── TASK 5 ───────────────────────────────────────────────────────────────────
\item \textbf{[4~pts.]} Documentation.\\
Submit a report (PDF) containing:
\begin{itemize}
    \item description of each pipeline step with corresponding screenshots,
...
\begin{itemize}
    ...
    \item Source code and guide: \texttt{NAVOD.md} in the repository
\end{itemize}
