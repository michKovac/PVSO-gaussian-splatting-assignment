...
Študent prejde celým pracovným postupom od fotografií až po interaktívny 3D viewer,
...
% ── ÚLOHA 1 ──────────────────────────────────────────────────────────────────
\item \textbf{[5~b.]} Spustenie postupu na referenčnom datasete.\\
Táto úloha slúži na \textbf{pochopenie celého pracovného postupu} a overenie funkčnosti
prostredia ešte pred tým, ako budete pracovať na vlastnom datasete.
Na referenčných dátach sa naučíte každý krok bez toho, aby ste riešili
problémy so snímaním.\\[4pt]
...
Celý postup spustite sami od začiatku podľa návodu \texttt{NAVOD.md}:
...
Zdokumentujte postup screenshotmi z každého kroku (COLMAP GUI, priebeh trénovania,
viewer). Uveďte dosiahnutú metriku \textbf{PSNR} po 7\,000 a 30\,000 iteráciách.

% ── ÚLOHA 2 ──────────────────────────────────────────────────────────────────
\item \textbf{[10~b.]} Snímanie vlastnej scény kamerou Ximea.\\
...
% ── ÚLOHA 4 ──────────────────────────────────────────────────────────────────
\item \textbf{[5~b.]} Dokumentácia.\\
Odovzdajte správu (PDF) obsahujúcu:
\begin{itemize}
    \item popis každého kroku s príslušnými screenshotmi,
...
\begin{itemize}
    ...
    \item \textbf{Repozitár s Docker prostredím, návodmi a zadaním:}\\
          ...
          Obsahuje: \texttt{NAVOD.md}, \texttt{Dockerfile}, \texttt{run.sh}, \texttt{run.bat}
\end{itemize}
